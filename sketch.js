...
function setup() {
  ...
  inputElement.style("background","#2f3e46") //文字框的背景顏色
  ...
  btnMoveElement.style("background","#2f3e46") //按鈕的背景顏色
...
//"暫停"按鈕的設定
  ...
  btnStopElement.style("background","#2f3e46") //按鈕的背景顏色
  btnStopElement.mousePressed(face_move)//按鈕被按下後會執行face_move函數
